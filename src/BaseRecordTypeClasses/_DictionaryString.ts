...
class _DictionaryString extends _BaseRecordType {
    ...
    private _mbi31: _MultiByteInt31;
    ...
    public static ValueToString(value: number): string {
        ...
        var str: string = _DictionaryString._Dictionary[value / 2];
    ...
    public static StringToValue(str: string): number {
        var index: number = _DictionaryString._Dictionary.indexOf(str);
    ...
    protected processNBFXArray(arr: Uint8Array): $IConsumeNBFXArrayResult<this> {
        var mbi31: _MultiByteInt31 = new _MultiByteInt31();
        
        var mbi31ConsumeResult: $IConsumeNBFXArrayResult<_MultiByteInt31> = mbi31.consumeNBFXArray(arr);
